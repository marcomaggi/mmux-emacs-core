...
AC_DEFUN([MMUX_EMACS_LDOUBLE_CONSTANT_TEST],[MMUX_EMACS_LONGDOUBLEOF_TEST([$1],[$1])])
AC_DEFUN([MMUX_EMACS_LDOUBLE_CONSTANT_TESTS],[m4_map_args_w($1,[MMUX_EMACS_LDOUBLE_CONSTANT_TEST(],[)])])
